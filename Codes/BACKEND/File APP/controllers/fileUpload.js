...
exports.localFileUpload = async (req, res) => {
    try {
        ...
        let path =
            __dirname // it is showing the current directory 
            + "/files/" + Date.now() + `.${file.name.split(".")[1]}`;
...
exports.imageUpload = async (req, res) => {
    try {
        ...
        const response = await uploadFileToCloudinary(file, "Varunji");
...
exports.videoUpload = async (req, res) => {
    try {
        ...
        const response = await uploadFileToCloudinary(file, "Varunnji");
        console.log(response);
...
exports.imageSizeReducer = async (req, res) => {
    try {
        ...
        const response = await uploadFileToCloudinary(file, "Varunji", 30);
        console.log(response);
