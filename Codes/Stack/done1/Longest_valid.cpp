...
// Stack top always represents the last position where a valid substring cannot extend past.

// So when we find a matching ):

// length = current_index - last_invalid_index
